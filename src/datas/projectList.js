...
const projectList = {
  openclassrooms: [
    ...
    },
    {
      ...
      title: "Ohmyfood",
      description:
        "Une occasion de consolider ses connaissances en HTML et CSS uniquement. Un projet avec comme contrainte l'obligation de le développer en mobile-first, et en y intégrant des animations css.",
      cover: ohmyfood,
